...
$(function() {
	...
	var delete_diloag	= $("#delete_div").dialog({
        ...
        buttons: {
            "Yes Continue": function() {
                $.ajax({
                    url: "<?php echo $this->Html->url(array('plugin' => 'page','controller' => 'pages','action' => 'admin_delete')); ?>",
                    data: {
                        'id': user_id
                    },
                    type: 'post',
   ...
   var myDialogClose = $("#active_div").dialog({
        ...
        buttons: {
            "Yes Continue": function() {
                $.ajax({
                    url: "<?php echo $this->Html->url(array('plugin' => 'page','controller' => 'pages','action' => 'change_status_active')); ?>",
                    data: {
                        'id': user_id
                    },
                    type: 'post',
   ...
   var myInDialogClose 	=	$("#inactive_div").dialog({
        ...
        buttons: {
            "Yes Continue": function() {
                $.ajax({
                    url: "<?php echo $this->Html->url(array('plugin' => 'page','controller' => 'pages','action' => 'change_status_inactive')); ?>",
                    data: {
                        'id': user_id
                    },
                    type: 'post',
...
<div id='delete_check' style="display:none">Are you sure you want to delete this Page ?</div>
<div id='active_check' style="display:none">Are you sure you want to active this Page ?</div>
<div id='inactive_check' style="display:none">Are you sure you want to inactive this Page ?</div>
      ...
      <td><div class=" pull-left">
        ...
        <div class=" pull-right">
          <?php 
			...
			echo $this->Form->text('name',array('placeholder'=> __('Search By Page',true),'class'=>'input-medium')); ?>
        ...
        <table width="100%"  class="table table-bordered table-striped new" align="center" border="0" cellspacing="0" cellpadding="0">
          <thead>
            <tr style="height:30px;">
              ...
              <td  align="left" class="" style="width:180px;"><?php   echo $this->Paginator->sort('name', __('Page Name',true),array('char'=>true));?></td>
              
              <td  align="left" class="" style="width:140px;"><?php   echo $this->Paginator->sort('modified',__('Modified',true),array('char'=>true));?></td>
	...
	if( !empty($result) ) {
		...
		?>
            <tr style="height:30px;" class="gallerytr" id="row_<?php echo $records[$model]['id']; ?>">
              ...
              <td  align="left"><?php echo $this->Time->format( 'm/d/Y h:i A',$records[$model]['modified'],null,"CST"); ?></td>
             
              <td  align="center" id="action_<?php echo $records[$model]['id']; ?>"><?php
				
				echo $this->Html->link('<i class="fa fa-edit"></i> '.__('Edit',true), array('plugin' => 'page','controller' => 'pages','action' => 'edit',$records[$model]['id']),array('class'=>'btn btn-primary','escape' => false));
				
				?>
                <?php 
				//	if($records[$model]['status'] == 1){
				?>
                <a href='javascript::void(0)' onclick='return inactive_function("Are you sure you want to inactive this time value?",this);' id='inactive_<?php echo $records[$model]['id']; ?>' class='btn btn-danger' data-toggle="tooltip" data-placement="top" title="Click here to inactive."><i class="fa fa-thumbs-down"></i>Inactive</a>
                <?php 	
					//}else { ?>
                <a href='javascript::void(0)' onclick='return active_function("Are you sure you want to active this time value?",this);' id='active_<?php echo $records[$model]['id']; ?>' class='btn btn-info' data-toggle="tooltip" data-placement="top" title="Click here to active."><i class="fa  fa-thumbs-up"></i> Active</a>
                <?php //}
				?>
			<?php	/* <a href='javascript::void(0)' onclick='return delete_function("Are you sure you want to delete this Page ?",this);' id='delete_<?php echo $records[$model]['id']; ?>' class='btn btn-danger' data-toggle="tooltip" data-placement="top" title="Click here to delete."><i class="fa fa-trash-o"></i> Delete</a> */
			?>
              </td>
			...
			buttons: {
				"Yes Continue": function() {
					var data = { 'fare_ids[]' : []};
							...
							$.post("<?php echo $this->Html->url(array('plugin' => 'page','controller' => 'pages','action' => 'delete_all')); ?>", data, function(sdata){
								if(sdata == 'Success') {
									$(".case:checked").each(function() {
										dad.dialog('close');
	...
	var aad	=	$("#active_check").dialog({
        ...
        buttons: {
            "Yes Continue": function() {
				...
				$.post("<?php echo $this->Html->url(array('plugin' => 'page','controller' => 'pages','action' => 'active_all')); ?>", data, function(sdata){
        			if(sdata == 'Success') {
						$(".case:checked").each(function() {
								aad.dialog('close');
        ...
        buttons: {
            "Yes Continue": function() {
               var data = { 'fare_ids[]' : []};
				...
				$.post("<?php echo $this->Html->url(array('plugin' => 'page','controller' => 'pages','action' => 'inactive_all')); ?>", data, function(sdata){
        			if(sdata == 'Success') {
						$(".case:checked").each(function() {
								iaad.dialog('close');
