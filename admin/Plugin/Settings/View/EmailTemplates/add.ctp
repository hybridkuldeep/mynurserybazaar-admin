...
<div class="span12" >
		...
		<div class="control-group <?php echo ($this->Form->error($model.".name"))? "error":"";?>">
		 ...
		 <?php 
			...
			<div class="controls">
			<?php	echo $this->Form->select($model.".action", $Action_options, array('empty' => '-- Select One --','onchange'=>'constant();'));  ?>
            <span class="help-inline"><?php echo $this->Form->error($model.".action",array("wrap"=>false)); ?></span>
            </div>
          </div>
		  ...
		  <div  class="control-group <?php echo ($this->Form->error($model.".constants"))? "error":"";?>">
			...
			<div class="controls">
				...
				<?php
				echo $this->Html->link('<i class="icon-white "></i> Insert Variable', 'javascript:void(0)',array('class'=>'btn  btn-success','escape' => false,'onclick' => 'return InsertHTML()',"escape" => false));
				?></span>
