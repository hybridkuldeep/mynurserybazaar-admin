      ...
      <table class="table table-hover table-nomargin dataTable table-bordered display" id="dTbl">
         <thead>
           <tr>
			<th style="background-color: #EEEEEE;" colspan="6">
				<div class="row-fluid"><h1><?php echo __("Calendar Influencers",true); ?><div class="pull-right">
                 <?php 
         ...
         <tbody>
            ...
            <tr id="driver_row_<?php echo $records[$model]['id']; ?>" >
               ...
               <td class='hidden-1024'><?php echo $records[0]['full_name']; ?></td>
               <td class='hidden-1024'><?php echo $records[0]['email']; ?></td>
