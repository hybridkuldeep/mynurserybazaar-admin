...
<table width="100%"  class="table table-bordered table-striped new" align="center" border="0" cellspacing="0" cellpadding="0">
 <thead>
  ...
  <?php /*?>	<td  align="left" class="" style="width:90px;"><?php   echo $this->Paginator->sort('image', __('User Photo',true),array('char'=>true));?></td><?php */?>
	<td  align="left" class="" style="width:20%;"><?php   echo $this->Paginator->sort('full_name', __(' Name',true),array('char'=>true));?></td>
	<td  align="left" class="" style="width:10%;"><?php   echo $this->Paginator->sort('phone', __('Phone',true),array('char'=>true));?></td>
	...
	<td  align="left" class="" style="width:20%;"><?php  echo $this->Paginator->sort('email',__('Email',true),array('char'=>true));?></td>
	
	<td  align="left" class="" style="width:20%;"> <?php   echo $this->Paginator->sort('created',__('Created',true),array('char'=>true));?></td>
	
	<td align="center" class="" style="width:20%;"><?php echo __('Action'); ?></td>
  </tr>
  </thead>
   <tbody >
	<?php 
	...
	// $albums_categories = $this->requestAction(array('plugin'=>'category','controller'=>'categories','action'=>'get_categories','id','categories'));
		...
		<td  align="left" >
			...
			<td >
			<?php echo $this->Html->link('<i class="fa fa-edit"></i> '.__('Edit',true), array('plugin' => 'usermgmt','controller' => 'usermgmt','action' => 'edit_customer',$records[$model]['id']),array('class'=>'btn btn-primary','escape' => false)); ?>
