...
<?php 
	  echo $this->Form->create($model, array('url' => array('plugin' => 'calendar','controller' => 'calendars', 'action' => 'edit'),'enctype' => 'multipart/form-data')); 
 ...
 <thead>
   <tr>
     <th style="background-color: #EEEEEE;">
		<div class="row-fluid">
				<!--heading-->
               <h1><?php echo __('Edit Calendar',true); ?>
