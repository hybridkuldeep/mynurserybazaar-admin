...
$(function(){
	...
	$( "#delete_user_div").dialog({
			...
			buttons:{
				...
				$.ajax({
					url: "<?php echo $this->Html->url(array('plugin' => 'email','controller' => 'email_templates','action' => 'delete')); ?>",
					data: {'id':user_id},
					type: 'post',
					success: function(r){
						if(r=='error'){
...
<div id='delete_user_div'></div>
    <table class="table table-bordered table-striped">
 		 <thead>
    		<tr>
              ...
              <div class="row-fluid"><h1><?php echo __("Email Templates"); ?><div class="pull-right">
                 <?php 
 ...
 <thead>
   <tr style="height:30px;">
	...
	<td  align="left" class="" style="width:100px;"><?php  echo $this->Paginator->sort('subject',__('Subject'),array('char'=>true));?></td>
	<td  align="left" class="" style="width:130px;"><?php  echo $this->Paginator->sort('email_type',__('Action'),array('char'=>true));?></td>
	<td  align="left" class="" style="width:130px;"><?php  echo $this->Paginator->sort('modified',__('Modified'),array('char'=>true));?></td>
   ...
   <tbody >
              ...
              <tr style="height:30px;" class="gallerytr">
					<td  align="left" class="">
					  ...
					  <td  align="left" class="">
					     <?php echo __($records[$model]['subject']);?>
           
           
                      </td>
					   <td  align="left" class="">
					     <?php echo __($records[$model]['email_type']);?>
              ...
              <td  align="left"><?php echo $this->Time->format( 'm/d/Y h:i A',$records[$model]['created'],null,"CST"); ?></td>								   
                      ...
                      <td  align="center">
						<?php echo $this->Html->link('<i class="icon-pencil icon-white"></i> '.__('Edit'), array('plugin' => 'email','controller' => 'email_templates','action' => 'edit',$records[$model]['id']),array('class'=>'btn btn-primary','onclick' => 'return InsertHTML()','escape' => false));
					?>&nbsp;
