...
<form method="post" class="form-horizontal">
   <div class="pull-left grytxt12 pr10 pt5"><?php echo $paginator->counter(array('format' => 'Page %page% of&nbsp;&nbsp;%pages%, Total records %count%  ')); ?></div>
  <?php /* <div class="pull-left"><select  onchange="this.form.submit();" name="data[recordsPerPage]" style="width:85px;"  class="lstfld60">
